...
#        self.test_description = self.test_result.getDescription(test_method)
        self.test_description = test_method._testMethodDoc
        ...
        self.test_id = test_method.id() if outcome != self.SKIP else "%s // skip reason : %s" % (test_method.id(), self.err)
        if subTest:
            self.test_id = subTest.id() if outcome != self.SKIP else "%s // skip reason : %s" % (subTest.id(), self.err)
...
#        doc_first_line = test._testMethodDoc
